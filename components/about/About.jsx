      ...
      <div className="flex flex-col sm:flex-col lg:flex-row justify-between">
        <div className="text-white w-[80%] smw-[80%] lg:w-[50%]">
          ...
          <h1 className="text-lg sm:text-lg lg:text-xl pl-16 pt-11">
            dBug Labs, a student-run club dedicated to the art of debugging &
            testing! We are a group of passionate students interested in solving
            complex problems through effective debugging techniques. Our mission
            is to provide a supportive community for individuals who want to
            enhance their debugging skills and share their knowledge with
            others. We strive to create a fun and collaborative environment
            where students can collaborate to share ideas, work on projects, and
        ...
        <div>
          ...
          <div className="flex w-full justify-center">
            <img
              className="pr-0 sm:pr-48 lg:pr-16   "
              src={aboutsvg}
              alt="image"
            />
          </div>
