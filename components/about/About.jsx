...
function About() {
  return (
    <div className=" w-full  bg-black pl-16 pt-16 ">
      

      <div className="flex flex-col sm:flex-col md:flex-row justify-between">
        <div className="text-white w-[80%] smw-[80%] lg:w-[50%]">
          <h1 className="text-white text-6xl pb-20">ABOUT DBUG LABS</h1>
          <h1 className="text-lg sm:text-lg lg:text-xl ">
        ...
        <div>
          ...
          <div>
            <img className="pr-0 sm:pr-0 lg:pr-16   " src={aboutsvg} alt="image" />
            </div>
        </div>  
      </div>
      <div className="flex w-full justify-between ">
